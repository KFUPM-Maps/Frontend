export default function SearchBar({firstBuilding, setFirstBuilding, secondBuilding, setSecondBuilding}){
    ...
    return(
        <div className="flex gap-2 border-border border-t-highlight border items-center w-10/12 md:w-1/2 absolute left-1/2 -translate-x-1/2 md:mt-5 bg-bg-light rounded-2xl p-2 px-4">
